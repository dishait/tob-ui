<template>
	<view class="pb-20">
		...
		<example title="圆角">
			<view class="mx-6">
				<view class="mt-4" v-for="v of roundeds" :key="v.type"><t-textarea :rounded="v.type" v-model="rounded" :placeholder="v.desc" /></view>
			</view>
		</example>
		
		<example title="尺寸">
			<view class="mx-6">
				<view class="mt-4" v-for="v of sizes" :key="v.type"><t-textarea :size="v.type" v-model="size" :placeholder="v.desc" /></view>
			</view>
		</example>
