<template>
	<view class="t-search" :class="[Size, Rounded, Shadow, Color]" @click="click">
		...
		<t-icon :type="clearIcon" :class="[ClearIconVisible]" class="search-claer-icon" @click="clearIconClick" />
 ...
 * @property {String} leftIcon 左侧图标，默认为search
 * @property {String} maxLength 最大长度，默认为-1，无限长
 * @property {String} clearIcon 清除图标，默认为close-circle
 * 
 * @property {Boolean} light = [true|false] 亮色，默认为false
 * @property {Boolean} outline = [true|false] 轮廓，默认为false
 *
 * @property {Boolean} clearable = [true|false] 是否能清除，默认为true，开启清除
 *
 * @property {String} inputTextAlign = [left|center|right] 输入框文本对齐，默认为left，左对齐
 *
 * 	@value left 左对齐
 * 	@value center 居中
 * 	@value right 右对齐
 *
 * @property {String} color = [primary|secondary|accent|neutral|base|info|success|warning|error|...] 类型，默认为base，基础
 *
 * 	@value primary 主要
 * 	@value secondary 次要
 * 	@value accent 强调
 ...
 * 	@value error 错误
 *
 * @property {String} rounded = [none|sm|base|md|lg|xl|2xl|3xl|full|...] 圆角，默认为base，基础圆角
 *
 * 	@value none 无
 * 	@value sm 小
 * 	@value base 基础
 ...
 * 	@value full 圆
 *
 * @property {String} shadow = [none|sm|base|md|lg|xl|...] 阴影，默认为none，无阴影
 *
 * 	@value none 无
 * 	@value sm 小
 * 	@value base 基础
